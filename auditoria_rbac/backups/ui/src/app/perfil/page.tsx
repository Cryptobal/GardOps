...
export default function PerfilPage() {
  ...
  const updateProfile = async () => {
    try {
      ...
      toast ? toast({ title: 'Perfil actualizado', type: 'success' }) : console.log('Perfil actualizado');
  ...
  const changePassword = async () => {
    ...
    try {
      ...
      toast ? toast({ title: 'Contraseña actualizada', type: 'success' }) : console.log('Contraseña actualizada');
