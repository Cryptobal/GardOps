-- =====================================================
-- CORRECCIÓN VISTA CENTRAL - IDs Reales de Llamados
-- =====================================================

-- Este script corrige la vista central_v_llamados_automaticos
-- para que use IDs reales de la tabla central_llamados
-- en lugar de generar IDs aleatorios que no existen
...
unidos_con_estado AS (
  SELECT 
    -- CAMBIO CLAVE: Usar ID real si existe, o generar uno determinístico
    COALESCE(
      cl.id, 
