-- =====================================================
-- CORRECCIÓN VISTA CENTRAL - Nuevo Sistema de Estados
-- =====================================================

-- Eliminar vista existente
DROP VIEW IF EXISTS central_v_llamados_automaticos;

-- Crear nueva vista que use el nuevo sistema de estados
...
WITH instalaciones_con_plan AS (
  ...
  WHERE 
    -- NUEVO SISTEMA: Usar tipo_turno en lugar de estado
    pm.tipo_turno = 'planificado'
...
COMMENT ON VIEW central_v_llamados_automaticos IS 'Vista automática que calcula llamados de monitoreo desde pauta mensual - CORREGIDA para usar nuevo sistema de estados (tipo_turno = planificado)';
...
SELECT 
  'Vista corregida para nuevo sistema de estados' as status,
