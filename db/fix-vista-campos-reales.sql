-- =====================================================
-- FIX FINAL - Solo Campos que Existen
-- =====================================================

-- El problema era que intentábamos usar campos que no existen en central_llamados
-- Solo usaremos los campos que realmente existen según el esquema

-- 1. Crear la vista con solo campos existentes
...
unidos_con_estado AS (
  SELECT 
    -- Solo campos que existen en central_llamados
    ...
    -- Campos que NO existen en central_llamados, los ponemos como NULL
...
SELECT 
  ...
  instalacion_nombre,
  estado_llamado,
  'Vista corregida - Solo campos existentes' as solucion
