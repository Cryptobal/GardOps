...
COMMENT ON VIEW as_turnos_v_pauta_diaria_unificada IS 'Vista unificada para Pauta Diaria: CORREGIDA - Incluye estado trabajado y formato de nombre (Nombre Apellido)';
