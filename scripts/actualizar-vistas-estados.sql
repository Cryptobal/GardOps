-- ===============================================
-- ACTUALIZACIÓN DE VISTAS CON NUEVA LÓGICA
-- ===============================================

-- 1. Actualizar vista de pauta diaria unificada
CREATE OR REPLACE VIEW public.as_turnos_v_pauta_diaria_unificada AS
...
CREATE OR REPLACE VIEW public.as_turnos_v_pauta_diaria_dedup_fixed AS
