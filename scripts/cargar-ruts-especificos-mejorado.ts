...
// Función principal
async function cargarRutsEspecificosMejorado() {
  console.log('🚀 Iniciando carga de RUTs específicos (versión mejorada)...');
...
export { cargarRutsEspecificosMejorado }; 