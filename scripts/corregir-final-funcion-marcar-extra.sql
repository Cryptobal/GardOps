-- Corregir función fn_marcar_extra para usar solo columnas existentes
...
BEGIN
  ...
  INSERT INTO public.TE_turnos_extras (
    pauta_id, guardia_id, instalacion_id, puesto_id, fecha, estado, created_at, updated_at
  ) VALUES (
    v_pauta_id, p_cobertura_guardia_id, p_instalacion_id, p_puesto_id, p_fecha, 'activo', NOW(), NOW()
  );
