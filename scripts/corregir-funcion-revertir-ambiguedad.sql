-- Corregir ambigüedad en función fn_revertir_a_plan
...
DECLARE
  ...
  v_has_logs boolean;
BEGIN
  -- Obtener estado anterior (usar alias para evitar ambigüedad)
  SELECT jsonb_build_object(
    'estado', pm.estado,
    'estado_ui', pm.estado_ui,
    'meta', pm.meta,
    'turno_extra_guardia_id', pm.turno_extra_guardia_id,
  ...
  -- Obtener estado posterior (usar alias para evitar ambigüedad)
  SELECT jsonb_build_object(
    'estado', pm.estado,
    'estado_ui', pm.estado_ui,
    'meta', pm.meta,
