-- ===============================================
-- CORRECCIÓN DE VISTA PARA MANEJAR "SIN COBERTURA"
-- ===============================================
-- Corrige la lógica para que PPCs marcados como "sin_cobertura" 
...
SELECT 
  ...
  CASE 
    ...
    -- NUEVA LÓGICA: Si el estado de la pauta mensual es 'sin_cobertura', respetarlo
...
COMMENT ON VIEW public.as_turnos_v_pauta_diaria_unificada IS 'Vista unificada de pauta diaria con lógica corregida - maneja sin_cobertura correctamente';
COMMENT ON VIEW public.as_turnos_v_pauta_diaria_dedup_fixed IS 'Vista deduplicada de pauta diaria con lógica corregida - maneja sin_cobertura correctamente';
