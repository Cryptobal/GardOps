-- Corregir vista para incluir información de turnos extra
...
SELECT 
  ...
  -- Información del guardia de reemplazo
...
LEFT JOIN public.guardias gr ON pd.reemplazo_guardia_id = gr.id
LEFT JOIN public.as_turnos_roles_servicio r ON pd.rol_id = r.id
