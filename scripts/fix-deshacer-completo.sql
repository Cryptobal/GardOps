-- ===============================================
-- SOLUCIÓN COMPLETA: Función fn_deshacer corregida
-- ===============================================
-- Corrige el error de columna "estado" inexistente y implementa la lógica correcta

-- 1. Eliminar la función existente
DROP FUNCTION IF EXISTS as_turnos.fn_deshacer(bigint, text);

-- 2. Crear la función corregida con lógica para los 5 casos
