...
async function fixVistaCruceMedianoche() {
  const client = await pool.connect();
  
  try {
    console.log('🔧 Creando vista con cruce de medianoche correcto');
    ...
    // 2. Crear vista con cruce de medianoche correcto
    console.log('2️⃣ Creando vista con cruce de medianoche correcto...');
    await client.query(`
    ...
    `);
    console.log('✅ Vista con cruce de medianoche correcto creada');
    ...
    console.log('✅ Vista con cruce de medianoche correcto creada exitosamente');
...
fixVistaCruceMedianoche().catch(console.error);
