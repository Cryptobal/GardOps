...
async function fixVistaHorasExactas() {
  const client = await pool.connect();
  
  try {
    console.log('🔧 Creando vista con horas exactas');
    ...
    // 2. Crear vista con horas exactas
    console.log('2️⃣ Creando vista con horas exactas...');
    await client.query(`
    ...
    `);
    console.log('✅ Vista con horas exactas creada');
    ...
    console.log('✅ Vista con horas exactas creada exitosamente');
