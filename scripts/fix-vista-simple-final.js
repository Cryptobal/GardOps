...
async function fixVistaSimpleFinal() {
  const client = await pool.connect();
  
  try {
    console.log('🔧 Creando vista simple final');
    ...
    // 2. Crear vista simple final
    console.log('2️⃣ Creando vista simple final...');
    await client.query(`
    ...
    `);
    console.log('✅ Vista simple final creada');
    ...
    console.log('✅ Vista simple final creada exitosamente');
...
fixVistaSimpleFinal().catch(console.error);