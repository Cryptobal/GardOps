...
async function fixVistaTimestampsDirectos() {
  const client = await pool.connect();
  
  try {
    console.log('🔧 Creando vista con timestamps directos');
    ...
    // 2. Crear vista con timestamps directos
    console.log('2️⃣ Creando vista con timestamps directos...');
    await client.query(`
      ...
      WITH slots_base AS (
        SELECT
          ...
          pm.id as pauta_id,
          po.id as puesto_id,
          -- Usar el timestamp final directamente
          ...
          CASE 
            WHEN timestamp_final < (now() AT TIME ZONE 'UTC') - interval '30 minutes'
            THEN true ELSE false 
          END as es_urgente,
          CASE 
            WHEN date_trunc('hour', timestamp_final AT TIME ZONE 'America/Santiago') = 
                 date_trunc('hour', now() AT TIME ZONE 'America/Santiago')
            THEN true ELSE false 
          END as es_actual,
          CASE 
            WHEN timestamp_final > (now() AT TIME ZONE 'UTC')
            THEN true ELSE false 
          END as es_proximo,
          CASE 
            WHEN timestamp_final < (now() AT TIME ZONE 'UTC')
        ...
        CROSS JOIN LATERAL (
          ...
          SELECT timestamp_final FROM (
            ...
            SELECT ((pm.anio || '-' || LPAD(pm.mes::text, 2, '0') || '-' || LPAD(pm.dia::text, 2, '0') || ' 19:00:00')::timestamp AT TIME ZONE 'America/Santiago') AT TIME ZONE 'UTC' as timestamp_final
            UNION ALL
            SELECT ((pm.anio || '-' || LPAD(pm.mes::text, 2, '0') || '-' || LPAD(pm.dia::text, 2, '0') || ' 20:00:00')::timestamp AT TIME ZONE 'America/Santiago') AT TIME ZONE 'UTC'
            UNION ALL
            SELECT ((pm.anio || '-' || LPAD(pm.mes::text, 2, '0') || '-' || LPAD(pm.dia::text, 2, '0') || ' 21:00:00')::timestamp AT TIME ZONE 'America/Santiago') AT TIME ZONE 'UTC'
            UNION ALL
            SELECT ((pm.anio || '-' || LPAD(pm.mes::text, 2, '0') || '-' || LPAD(pm.dia::text, 2, '0') || ' 22:00:00')::timestamp AT TIME ZONE 'America/Santiago') AT TIME ZONE 'UTC'
            UNION ALL
            SELECT ((pm.anio || '-' || LPAD(pm.mes::text, 2, '0') || '-' || LPAD(pm.dia::text, 2, '0') || ' 23:00:00')::timestamp AT TIME ZONE 'America/Santiago') AT TIME ZONE 'UTC'
            UNION ALL
            -- Horas del día siguiente: 00:00, 01:00, 02:00, 03:00, 04:00, 05:00, 06:00, 07:00
            SELECT (((pm.anio || '-' || LPAD(pm.mes::text, 2, '0') || '-' || LPAD(pm.dia::text, 2, '0'))::date + interval '1 day' + time '00:00:00') AT TIME ZONE 'America/Santiago') AT TIME ZONE 'UTC'
            UNION ALL
            SELECT (((pm.anio || '-' || LPAD(pm.mes::text, 2, '0') || '-' || LPAD(pm.dia::text, 2, '0'))::date + interval '1 day' + time '01:00:00') AT TIME ZONE 'America/Santiago') AT TIME ZONE 'UTC'
            UNION ALL
            SELECT (((pm.anio || '-' || LPAD(pm.mes::text, 2, '0') || '-' || LPAD(pm.dia::text, 2, '0'))::date + interval '1 day' + time '02:00:00') AT TIME ZONE 'America/Santiago') AT TIME ZONE 'UTC'
            UNION ALL
            SELECT (((pm.anio || '-' || LPAD(pm.mes::text, 2, '0') || '-' || LPAD(pm.dia::text, 2, '0'))::date + interval '1 day' + time '03:00:00') AT TIME ZONE 'America/Santiago') AT TIME ZONE 'UTC'
            UNION ALL
            SELECT (((pm.anio || '-' || LPAD(pm.mes::text, 2, '0') || '-' || LPAD(pm.dia::text, 2, '0'))::date + interval '1 day' + time '04:00:00') AT TIME ZONE 'America/Santiago') AT TIME ZONE 'UTC'
            UNION ALL
            SELECT (((pm.anio || '-' || LPAD(pm.mes::text, 2, '0') || '-' || LPAD(pm.dia::text, 2, '0'))::date + interval '1 day' + time '05:00:00') AT TIME ZONE 'America/Santiago') AT TIME ZONE 'UTC'
            UNION ALL
            SELECT (((pm.anio || '-' || LPAD(pm.mes::text, 2, '0') || '-' || LPAD(pm.dia::text, 2, '0'))::date + interval '1 day' + time '06:00:00') AT TIME ZONE 'America/Santiago') AT TIME ZONE 'UTC'
            UNION ALL
            SELECT (((pm.anio || '-' || LPAD(pm.mes::text, 2, '0') || '-' || LPAD(pm.dia::text, 2, '0'))::date + interval '1 day' + time '07:00:00') AT TIME ZONE 'America/Santiago') AT TIME ZONE 'UTC'
          ) timestamps
        ) slots
    ...
    `);
    console.log('✅ Vista con timestamps directos creada');
    ...
    console.log('✅ Vista con timestamps directos creada exitosamente');
...
fixVistaTimestampsDirectos().catch(console.error);
