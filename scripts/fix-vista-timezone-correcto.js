...
async function fixVistaTimezoneCorrect() {
  const client = await pool.connect();
  
  try {
    console.log('🔧 Creando vista con timezone correcto');
    ...
    // 2. Crear vista con timezone correcto
    console.log('2️⃣ Creando vista con timezone correcto...');
    await client.query(`
    ...
    `);
    console.log('✅ Vista con timezone correcto creada');
    ...
    console.log('✅ Vista con timezone correcto creada exitosamente');
