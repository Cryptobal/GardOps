...
async function fixVistaUltimaSimple() {
  console.log('🔧 Creando vista última simple\n');
  ...
  try {
    ...
    // 2. Crear vista última simple
    console.log('2️⃣ Creando vista última simple...');
    await pool.query(`
    ...
    `);
    console.log('✅ Vista última simple creada');
    ...
    console.log('\n✅ Vista última simple creada exitosamente');
