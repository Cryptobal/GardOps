-- Función fn_marcar_extra completamente nueva y simple
...
DECLARE
  ...
  v_dia integer;
  v_pauta_id bigint;
  v_valor_turno_extra numeric := 35000; -- Valor por defecto
BEGIN
  ...
  -- Retornar el resultado usando una consulta simple
  RETURN QUERY
  SELECT 
    pm.id,
    pm.estado,
