-- Recrear vista para incluir información de turnos extra

-- Eliminar la vista existente
DROP VIEW IF EXISTS as_turnos_v_pauta_diaria_unificada;

-- Crear la vista nueva
CREATE VIEW as_turnos_v_pauta_diaria_unificada AS
...
ORDER BY pd.puesto_id, pd.anio, pd.mes, pd.dia, pd.pauta_id DESC;
