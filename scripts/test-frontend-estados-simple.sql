-- ===============================================
-- SCRIPT DE TESTING SIMPLE PARA FRONTEND DE ESTADOS
-- ===============================================

-- 1. Limpiar datos de prueba anteriores
DELETE FROM public.as_turnos_pauta_mensual 
WHERE anio = 2025 AND mes = 9 AND dia BETWEEN 1 AND 4;
...
-- Día libre (debería mostrar círculo gris)
...
-- Puesto asignado (debería mostrar punto azul)
...
LEFT JOIN public.as_turnos_pauta_mensual pm ON po.id = pm.puesto_id 
  AND pm.anio = 2025 AND pm.mes = 9 AND pm.dia BETWEEN 1 AND 4
...
SELECT 'TESTING FRONTEND COMPLETADO EXITOSAMENTE' as resultado;
