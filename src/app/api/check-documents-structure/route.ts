...
export async function GET(req: NextRequest) {
  try {
    logger.debug('🔍 Verificando estructura de tablas de documentos...');
    ...
    try {
      ...
      logger.debug('📋 Tabla tenants existe:', tenantsExist);
      ...
      logger.debug('📋 Estructura de tabla documentos_tipos:');
      ...
      logger.debug('📋 Tabla alertas_documentos existe:', alertasExist);
      ...
      if (alertasExist) {
        ...
        logger.debug('📋 Estructura de tabla alertas_documentos:');
      ...
      logger.debug('📊 Resumen:', resultado.resumen);
