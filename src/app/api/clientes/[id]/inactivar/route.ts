  ...
  try {
    ...
    try {
      ...
      if (!cascada) {
        ...
        if (instalacionesActivas.length > 0) {
          console.log(`🔄 Inactivando ${instalacionesActivas.length} instalaciones en cascada...`);
          ...
          for (const instalacion of instalacionesActivas) {
            ...
            console.log(`✅ Instalación ${instalacion.nombre} inactivada automáticamente`);
          }
        }
      }
      ...
      console.log(`✅ Cliente ${cliente.nombre} inactivado exitosamente`);
