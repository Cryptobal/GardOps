...
export async function GET(request: NextRequest) {
  try {
    logger.debug('🚀 Generando plantilla Excel para nuevos clientes...');
    ...
    devLogger.success(' Plantilla Excel de clientes generada, tamaño:', buffer.length, 'bytes');
    ...
    logger.debug('✅ Plantilla Excel de clientes enviada correctamente');
    return response;
