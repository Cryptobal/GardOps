...
export async function GET(request: NextRequest) {
  ...
  console.log('🔍 Sistema Config: Acceso temporal permitido');
  ...
  try {
    ...
    console.log(`📊 [SISTEMA-CONFIG] Query: ${query}`);
    ...
    console.log(`✅ [SISTEMA-CONFIG] Configuración encontrada para tenant: ${tenantId || 'default'}`);
...
export async function POST(request: NextRequest) {
  // Permitir acceso temporal sin autenticación estricta
  console.log('🔍 Sistema Config POST: Acceso temporal permitido');
  ...
  try {
    ...
    console.log(`🔧 [SISTEMA-CONFIG] Actualizando configuración:`, body);
    ...
    console.log(`✅ [SISTEMA-CONFIG] Configuración guardada exitosamente`);
