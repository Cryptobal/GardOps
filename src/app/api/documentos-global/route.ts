...
export async function GET(request: NextRequest) {
  try {
    ...
    devLogger.search(' Query documentos globales:', { sql, params, filtros: { modulo, tipoDocumento, estado, entidadFilter, fechaDesde, fechaHasta } });
    ...
    devLogger.success(' Documentos globales obtenidos:', { 
