...
export async function GET(request: NextRequest) {
  try {
    ...
    logger.debug(`✅ Documentos obtenidos para guardia ${guardiaId}:`, result.rows.length);
...
export async function PUT(request: NextRequest) {
  try {
    ...
    logger.debug(`✅ Fecha de vencimiento actualizada para documento de guardia:`, result.rows[0]);
