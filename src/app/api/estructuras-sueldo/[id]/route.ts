...
export async function GET(
  ...
  try {
    ...
    logger.error('Error al obtener estructura de sueldo::', error);
    return NextResponse.json(
...
export async function PUT(
  ...
  try {
    ...
    logger.error('Error al actualizar estructura de sueldo::', error);
    return NextResponse.json(
      { success: false, error: 'Error interno del servidor' },
      { status: 500 }
    );
...
export async function DELETE(
  ...
  try {
    ...
    logger.error('Error al eliminar estructura de sueldo::', error);
    return NextResponse.json(
      { success: false, error: 'Error interno del servidor' },
      { status: 500 }
    );
