...
export async function POST(request: NextRequest) {
  try {
    console.log('🔧 Creando tabla sueldo_estructuras_roles...');
    ...
    console.log('✅ Tabla sueldo_estructuras_roles creada exitosamente');
    ...
    console.error('Error creando tabla sueldo_estructuras_roles:', error);
    return NextResponse.json(
