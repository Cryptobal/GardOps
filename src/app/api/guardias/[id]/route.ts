...
export async function PUT(
  ...
  devLogger.search(' API Guardias - Actualizando guardia:', params.id);
  ...
  try {
    ...
    devLogger.success(' API Guardias - Actualizando con datos:', body);
    devLogger.search(' Campos de ubicación recibidos:', {
    ...
    devLogger.search(' Campos a actualizar:', updateFields);
    devLogger.search(' Valores del query:', updateValues);
    ...
    logger.debug('✅ Guardia actualizado exitosamente');
...
export async function GET(
  ...
  devLogger.search(' API Guardias - Obteniendo guardia:', params.id);
  ...
  try {
    ...
    logger.debug('✅ Guardia obtenido exitosamente con vacaciones actualizadas');
...
export async function PATCH(
  ...
  devLogger.search(' API Guardias - Actualizando estado del guardia:', params.id);
  ...
  try {
    ...
    devLogger.success(' API Guardias - Actualizando estado con datos:', body);
    ...
    const guardiaActualizado = result.rows[0];
    logger.debug('✅ Estado del guardia actualizado exitosamente');
...
export async function DELETE(
  ...
  devLogger.search(' API Guardias - Eliminando guardia:', params.id);
  ...
  try {
    ...
    devLogger.success(' API Guardias - Eliminando guardia con ID:', guardiaId);
    ...
    logger.debug('✅ Guardia eliminado exitosamente');
