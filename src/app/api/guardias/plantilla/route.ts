...
export async function GET(request: NextRequest) {
  try {
    logger.debug('🚀 Generando plantilla Excel para nuevos guardias...');
    ...
    devLogger.success(' Plantilla Excel generada, tamaño:', buffer.length, 'bytes');
    ...
    logger.debug('✅ Plantilla Excel enviada correctamente');
    return response;
