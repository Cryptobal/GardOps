...
export async function POST(
  ...
  logger.debug("🔁 Endpoint activo: /api/instalaciones/[id]/ppc/desasignar");
  ...
  try {
    ...
    logger.debug(`✅ Guardia ${guardiaId} desasignado del puesto ${puesto_operativo_id} correctamente`);
