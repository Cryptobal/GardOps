...
export async function POST(
  ...
  logger.debug("🔁 Endpoint activo: /api/instalaciones/[id]/ppc/desasignar_v2");
  ...
  try {
    ...
    logger.debug("🔍 Desasignando puesto:", puesto_operativo_id, "de instalación:", instalacionId);
    ...
    logger.debug("🔄 Marcando puesto como PPC...");
    ...
    logger.debug(`✅ Puesto ${puesto_operativo_id} marcado como PPC correctamente`);
