...
export async function POST(
  ...
  try {
    ...
    try {
      ...
      console.log(`✅ [ASIGNACIÓN] Guardia ${guardia_id} asignado a puesto ${puesto_id} en instalación ${instalacionId}`);
      ...
      await sql`COMMIT`;
      console.log(`✅ [TRANSACCIÓN] Asignación completada exitosamente`);
