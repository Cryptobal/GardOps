...
export async function GET(request: NextRequest) {
  try {
    logger.debug('🚀 Exportando instalaciones a Excel...');
    ...
    logger.debug(`📊 Exportando ${result.rows.length} instalaciones...`);
    ...
    logger.debug('✅ Archivo Excel de instalaciones enviado correctamente');
    return response;
