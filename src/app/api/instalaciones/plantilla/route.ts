...
export async function GET(request: NextRequest) {
  try {
    logger.debug('🚀 Generando plantilla Excel para nuevas instalaciones...');
    ...
    devLogger.success(' Plantilla Excel de instalaciones generada, tamaño:', buffer.length, 'bytes');
    ...
    logger.debug('✅ Plantilla Excel de instalaciones enviada correctamente');
    return response;
