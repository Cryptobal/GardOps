...
export async function GET(request: NextRequest) {
  try {
    ...
    devLogger.search(' Cargando pauta completa del día:', fecha);
    ...
    logger.debug(`✅ Turnos asignados: ${turnosAsignados.length}`);
    ...
    logger.error('Error obteniendo pauta del día::', error);
    return NextResponse.json(
