...
export async function PUT(req: NextRequest) {
  ...
  try {
    ...
    devLogger.process(' PUT /api/pauta-diaria:', { turnoId, accion, guardiaId, motivo, observaciones });
    ...
    logger.debug('📋 Información del turno:', turno);
    ...
    switch (accion) {
      case 'eliminar_cobertura':
        ...
        logger.debug(`✅ Cobertura eliminada y registro liberado para puesto ${turno.puesto_id}, día ${turno.dia}`);
        break;
      ...
      case 'asistio':
        ...
        logger.debug(`✅ Asistencia marcada para puesto ${turno.puesto_id}, día ${turno.dia}`);
        break;
      ...
      case 'reemplazo':
        ...
        logger.debug(`🔄 Asignando reemplazo: Guardia ${guardiaId} para puesto ${turno.puesto_id}`);
        ...
        logger.debug(`✅ Reemplazo asignado para puesto ${turno.puesto_id}, día ${turno.dia}`);
        break;
      ...
      case 'asignar_ppc':
        ...
        logger.debug(`🔄 Asignando PPC: Guardia ${guardiaId} para puesto ${turno.puesto_id}`);
        ...
        logger.debug(`✅ PPC asignado para puesto ${turno.puesto_id}, día ${turno.dia}`);
        break;

      case 'sin_cobertura':
        // Marcar como sin cobertura
        logger.debug(`🔄 Marcando sin cobertura para puesto ${turno.puesto_id}`);
        ...
        logger.debug(`✅ Marcado sin cobertura para puesto ${turno.puesto_id}, día ${turno.dia}`);
        break;

      case 'agregar_observaciones':
        // Agregar o actualizar observaciones
        logger.debug(`🔄 Actualizando observaciones para puesto ${turno.puesto_id}`);
        ...
        logger.debug(`✅ Observaciones actualizadas para puesto ${turno.puesto_id}, día ${turno.dia}`);
        break;
