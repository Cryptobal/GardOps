...
export async function GET(
  ...
  try {
    logger.debug('🔍 Iniciando GET /api/pauta-diaria/turno-extra/planillas/[id]/descargar');
    ...
    devLogger.search(' Descargando planilla ID:', planillaId);
    ...
    devLogger.search(' Turnos encontrados:', turnos.length);
    ...
    devLogger.search(' Guardias agrupados:', guardiasAgrupados.size);
    ...
    devLogger.search(' Datos XLSX preparados:', datosXLSX.length - 1, 'filas');
    ...
    devLogger.search(' Archivo XLSX generado, tamaño:', buffer.length, 'bytes');
    ...
    logger.debug('✅ Archivo XLSX enviado correctamente');
