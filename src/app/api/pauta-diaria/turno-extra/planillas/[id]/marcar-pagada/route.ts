...
export async function POST(
  ...
  try {
    logger.debug('🔍 Iniciando POST /api/pauta-diaria/turno-extra/planillas/[id]/marcar-pagada');
    ...
    devLogger.search(' Marcando planilla como pagada ID:', planillaId);
    ...
    try {
      ...
      logger.debug('✅ Planilla marcada como pagada exitosamente');
