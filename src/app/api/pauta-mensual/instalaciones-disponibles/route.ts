...
export async function GET(request: NextRequest) {
  try {
    ...
    logger.debug(`🔍 Buscando instalaciones con pauta para ${mesAnterior}/${anioAnterior}`);
    ...
    logger.debug(`✅ Encontradas ${instalacionesResult.rows.length} instalaciones con pauta`);
