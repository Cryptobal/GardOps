...
export async function GET(request: NextRequest) {
  try {
    ...
    logger.debug(`🔍 Buscando instalaciones con pauta del mes anterior: ${mesAnterior}/${anioAnterior}`);
    ...
    logger.debug(`✅ Encontradas ${instalacionesResult.rows.length} instalaciones con pauta del mes anterior`);
