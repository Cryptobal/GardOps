...
export async function GET(
  ...
  try {
    ...
    logger.error('Error obteniendo series del rol::', error);
    return NextResponse.json(
...
export async function PUT(
  ...
  try {
    ...
    logger.error('Error actualizando series del rol::', error);
    return NextResponse.json(
      { success: false, error: 'Error interno del servidor' },
      { status: 500 }
    );
...
export async function DELETE(
  ...
  try {
    ...
    logger.error('Error eliminando series del rol::', error);
    return NextResponse.json(
      { success: false, error: 'Error interno del servidor' },
      { status: 500 }
    );
