...
export async function GET(req: NextRequest) {
  try {
    logger.debug('🔍 Verificando tipos de documentos disponibles...');
    ...
    logger.debug('📋 Estructura de tabla documentos_tipos:', structure.rows);
    ...
    logger.debug('📋 Tipos de documentos disponibles:', tipos.rows);
