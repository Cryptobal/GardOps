...
export async function POST(request: NextRequest) {
  try {
    ...
    devLogger.success(' Tipo de documento creado:', result.rows[0]);
...
export async function PUT(request: NextRequest) {
  try {
    ...
    devLogger.process(' Actualizando tipo con ID:', id, 'Datos:', body);
    ...
    devLogger.success(' Tipo actualizado exitosamente:', result.rows[0]);
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    logger.debug('🗑️ Eliminando tipo con ID:', id);
    ...
    devLogger.success(' Tipo eliminado exitosamente:', result.rows[0]);
