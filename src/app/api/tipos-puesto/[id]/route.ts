...
export async function GET(
  ...
  try {
    ...
    logger.error('Error obteniendo tipo de puesto::', error);
    return NextResponse.json(
...
export async function PUT(
  ...
  try {
    ...
    logger.debug(`✅ Tipo de puesto ${id} actualizado`);
    ...
    logger.error('Error actualizando tipo de puesto::', error);
    return NextResponse.json(
      { error: 'Error interno del servidor' },
      { status: 500 }
    );
...
export async function DELETE(
  ...
  try {
    ...
    logger.debug(`✅ Tipo de puesto ${id} eliminado`);
    ...
    logger.error('Error eliminando tipo de puesto::', error);
    return NextResponse.json(
      { error: 'Error interno del servidor' },
      { status: 500 }
    );
