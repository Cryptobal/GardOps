...
export default function PautaDiariaPage() {
  ...
  console.log('🔄 [PautaDiariaPage] RENDERIZANDO:', {
    fecha,
    incluirLibres,
    loading,
    error,
  ...
  useEffect(() => {
    ...
    console.log('🔍 [PautaDiariaPage useEffect] EJECUTANDO con dependencias:', {
      fecha,
      incluirLibres,
      isMounted
    });
    ...
    return () => {
      console.log('🧹 [PautaDiariaPage useEffect] CLEANUP');
      isMounted = false;
    };
  }, [fecha, incluirLibres]);
