  ...
  ({ value, onChange, placeholder, className, disabled, ...props }, ref) => {
    ...
    const handleChange = React.useCallback((e: React.ChangeEvent<HTMLInputElement>) => {
      try {
        ...
        console.warn('Error en SafeFilterInput change:', error);
        setHasError(true);
    ...
    const handleKeyDown = React.useCallback((e: React.KeyboardEvent<HTMLInputElement>) => {
      try {
        ...
        console.warn('Error en SafeFilterInput keydown:', error);
      }
    }, []);
    ...
    const handleFocus = React.useCallback((e: React.FocusEvent<HTMLInputElement>) => {
      try {
        ...
        console.warn('Error en SafeFilterInput focus:', error);
      }
    }, []);
    ...
    const handleBlur = React.useCallback((e: React.FocusEvent<HTMLInputElement>) => {
      try {
        ...
        console.warn('Error en SafeFilterInput blur:', error);
      }
    }, []);
