...
export function SearchableCombobox({
  ...
  React.useEffect(() => {
    devLogger.search(' SearchableCombobox - Opciones recibidas:', options.length, options);
  }, [options]);
              ...
              <div className="space-y-1">
                {options.map((option) => (
                  <div
                    key={option.value}
                    onClick={(e) => {
                      logger.debug('🖱️ Seleccionando guardia:', option.label, 'disabled:', option.disabled);
