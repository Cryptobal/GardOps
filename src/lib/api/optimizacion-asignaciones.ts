...
export const obtenerGuardiasConCoordenadas = async (): Promise<GuardiaConCoordenadas[]> => {
  try {
    ...
    logger.debug('API Guardias - Response:', result);
    ...
    logger.debug('API Guardias - Procesados:', guardias.length);
    return guardias;
  } catch (error) {
    logger.error('Error obteniendo guardias con coordenadas::', error);
    return [];
  }
}
...
export const obtenerInstalacionesConCoordenadas = async (): Promise<InstalacionConCoordenadas[]> => {
  try {
    ...
    logger.debug('API Instalaciones - Response:', result);
    ...
    logger.debug('API Instalaciones - Procesados:', instalaciones.length);
    return instalaciones;
  } catch (error) {
    logger.error('Error obteniendo instalaciones con coordenadas::', error);
    return [];
  }
}
