...
export async function guardarHistorialCalculo(
  ...
  try {
    ...
    console.error('Error al guardar historial de cálculo:', error);
    throw error;
  }
}
...
export async function obtenerUltimoCalculo(
  ...
  try {
    ...
    console.error('Error al obtener último cálculo:', error);
    return null;
  }
}
...
export async function obtenerHistorialPeriodo(
  ...
  try {
    ...
    console.error('Error al obtener historial del período:', error);
    return [];
  }
}
